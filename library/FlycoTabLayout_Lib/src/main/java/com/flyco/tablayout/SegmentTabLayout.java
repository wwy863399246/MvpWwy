...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mIndicatorDrawableColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorDrawableColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_drawable_color, Color.parseColor("#222831"));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mIndicatorDrawable.setColor(mIndicatorDrawableColor);
