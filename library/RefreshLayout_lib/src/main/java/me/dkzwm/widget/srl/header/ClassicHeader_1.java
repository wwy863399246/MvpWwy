 ...
 * @author dkzwm
 */
public class ClassicHeader_1<T extends IIndicator> extends AbsClassicRefreshView<T>
{
    @StringRes
    ...
    public ClassicHeader_1(Context context)
    {
        this(context, null);
    }

    public ClassicHeader_1(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public ClassicHeader_1(Context context, AttributeSet attrs, int defStyle)
    {
