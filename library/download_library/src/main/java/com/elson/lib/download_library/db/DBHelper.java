package com.elson.lib.download_library.db;
...
import com.elson.lib.download_library.Constants;
...
class DBHelper extends SQLiteOpenHelper
{
    ...
    {
        String sql = "create table if not exists " + Constants.TABLE_DOWN + "(" // 创建下载表
                + Constants.ID + " integer PRIMARY KEY autoincrement, " // 自增长id.
                + Constants.DOWN_ID + " varchar, " // 下载id
                + Constants.DOWN_NAME + " varchar, " // 名字
                + Constants.DOWN_ICON + " varchar, " // 图片
                + Constants.DOWN_URL + " varchar, " //下载的url
     ...
     * @return 查询结果游标
     */
    static Cursor selectInfo(Context context, String table, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String
    ...
    static void deleteAll(Context context, String table)
    {
        String sql="delete from "+table;
        DBHelper.getInstance(context).execSQL(sql); // 执行删除操作
    }
