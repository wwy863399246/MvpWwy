...
public class EmotionUtils
{
    ...
    static
    {
        ...
        EMOTION_CLASSIC_MAP.put("#A101", R.mipmap.face1);
        EMOTION_CLASSIC_MAP.put("#A102", R.mipmap.face2);
        EMOTION_CLASSIC_MAP.put("#A103", R.mipmap.face3);
        EMOTION_CLASSIC_MAP.put("#A104", R.mipmap.face4);
        EMOTION_CLASSIC_MAP.put("#A105", R.mipmap.face5);
        EMOTION_CLASSIC_MAP.put("#A106", R.mipmap.face6);

        //		EMOTION_CLASSIC_MAP.put("[呵呵]", R.drawable.face1);
        //		EMOTION_CLASSIC_MAP.put("[嘻嘻]", R.drawable.face2);
        //		EMOTION_CLASSIC_MAP.put("[哈哈]", R.drawable.face3);
        //		EMOTION_CLASSIC_MAP.put("[爱你]", R.drawable.face4);
        //		EMOTION_CLASSIC_MAP.put("[挖鼻屎]", R.drawable.face5);
        //		EMOTION_CLASSIC_MAP.put("[吃惊]", R.drawable.face6);
    ...
    public static int getImgByName(int EmotionType, String imgName)
    {
        ...
        switch (EmotionType)
        {
            case EMOTION_CLASSIC_TYPE:
                ...
                break;
            default:
                LogUtils.loge("the emojiMap is null!! Handle Yourself ");
                break;
        }
